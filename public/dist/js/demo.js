...
(function ($) {
  ...
  $(document).ready(function() {
    ...
    $('#toggle-mini-sidebar-button').on('click', function() {
      toggleMiniSidebar();
    });
  });
  ...
  $footer_fixed_checkbox.on('click', function () {
    $footer_fixed_checkbox.prop('checked', true); // Pastikan checkbox selalu dicentang
  })
...
// tombol mata di user /item modal

$('#detailModal{{$row->id}}').on('show.bs.modal', function (event) {
    var button = $(event.relatedTarget); // Tombol yang memicu modal
    var id = button.data('id'); // Dapatkan ID atau data lain dari tombol

    // Lakukan permintaan AJAX atau manipulasi data sesuai kebutuhan
    $.ajax({
        url: '/user/' + id, // Ganti dengan rute yang sesuai untuk mendapatkan data pengguna
