...
@section('container')
    <div class="container-fluid">
        <div class="content-header">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="padding-left:15px;">Customize categories your galeries</h1>
                </div>
                <div class="col-sm-6">
                ...
                <form class="form-inline" style="padding: 5px">
                    ...
                    <div class="form-group mr-1">
                        <a class="btn btn-primary " data-toggle="tooltip" title="Buat Slider"
                            href="{{ route('categoryalbum.create') }}"><i class="fas fa-plus" style="margin:3px;"></i>Tambah</a>
                    </div>
                </form>
            </div>
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="{{ route('categoryalbum.edit', $category->id) }}" data-toggle="tooltip"
                                    title="Edit kategory"><button class="btn btn-sm btn-warning"><i
                                            class="fas fa-pencil-alt" style="color: white;"></i></button></a>
                                <form method="POST" action="{{ route('categoryalbum.destroy', $category->id) }}"
