...
@section('container')
    <div class="container-fluid">
        <div class="content-header">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="padding-left:15px;">List Album photo</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    @foreach ($albums as $album)
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="{{ route('galery.index', ['id' => $album->id]) }}"><button data-toggle="tooltip"
                                        title="Lihat album" class="btn btn-sm btn-primary"><i
                                            class="fas fa-eye"></i></button></a>


                                <a href="/crud?id={{ $album->id }}">
                                    <button class="btn btn-sm btn-success " style="margin-top: 1px;" data-toggle="tooltip" title="List gambar">
                                        <img class="w-4 h-5 text-white " src="{{asset('img/photo-list-album.svg')}}" >
                                    </button>
                                </a>
                                <a href="{{ route('album.edit', ['id' => $album->id]) }}"><button data-toggle="tooltip"
                                        title="Edit album" class="btn btn-sm btn-warning"><i
                                            class="fas fa-pencil-alt text-white"></i></button></a>
