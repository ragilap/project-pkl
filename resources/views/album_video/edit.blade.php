...
@section('main')
    <div class="col-md-12 col-sm-12 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6"
        ...
        <form action="{{ route('album.video.update', ['id' => $album->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group">
                ...
                <input type="text" class="form-control" style="border-radius:4px" name="nama_album"
                    placeholder="Nama album" value="{{ old('nama_album', $album->nama_album) }}" required>
            </div>
            <div class="form-group">
