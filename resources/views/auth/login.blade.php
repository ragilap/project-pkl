{{-- <div><a href="{{route('article.home')}}"><img src="{{asset('img/arrow-left-2827.svg')}}" /></a></div> --}}
{{-- <img width="80" height="80" src="https://img.icons8.com/carbon-copy/100/7950F2/left.png" style="margin-right:94%; margin-top:-9%"; alt="left"/> --}}
{{-- <x-guest-layout>
    <!-- Session Status -->
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            @if (Route::has('register'))
                <a href="{{ route('register') }}"
                    ...
                    style="margin-left: 9px" href="{{ route('register') }}">
                    {{ __('Register?') }}
                </a>
            @endif
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            let emailError = "<?php echo $errors->first('email'); ?>";
            let passwordError = "<?php echo $errors->first('password'); ?>";


            if (emailError) {
                alert("Email or Username is incorect");
            }

            if (passwordError) {
                alert("Password its incorect");
            }
...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Byte-craft</title>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="{{asset('dist/img/logo-byte-craft-white.png')}}" alt="" height="60">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Ratione. orbem vincere possumus</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Byte-craft.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}">
                                        @csrf
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="login" :value="old('login') placeholder="Enter username">
                                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Byte-craft. Crafted with <i class="mbri-github font-bold"></i> by Ragil adi prasetio
                            </p>
                        </div>
                    </div>
                </div>
