...
@section('container')
    <div class="container-fluid">
        <div class="content-header">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="padding-left:15px;">Customize Your Maps </h1>
                </div>
                <div class="col-sm-6">
                    ...
                    @foreach ($maps as $map)
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="{{ route('map.edit', $map->id) }}" data-toggle="tooltip" title="Edit Maps"><button
                                        class="btn btn-sm btn-warning"><i class="fas fa-pencil-alt"
