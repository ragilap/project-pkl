                                                    ...
                                                    <div class="v2_chapter_item">
                                                        <div class="chapter_item_contents">
                                                            ...
                                                            <div class="chapter_item_list_toggle">
                                                                ...
                                                                <div class=""><i class="la la-medal"></i>430 / 430
                                                                </div>
                                                            </div>
                                                            <div class="chapter_item_list"
                                                                style="display: none; width: 100%;">
                                                                <a class="chapter_item_item "
                                                                    href="main/livecode/389/928/5385?pr=0">
                                                                    <i class="la la-book-open"></i> | Metode Belajar dengan
                                                                    AI
                                                                ...
                                                                <a class="chapter_item_item "
                                                                    ...
                                                                    <i class="la la-book-open"></i> | Kenapa Belajar Data
                                                                    harus
                                                                    Coding?
                                                                    <span class="float-right">
                                                                        <i class="la la-check"></i>
                                                                ...
                                                                <a class="chapter_item_item "
                                                                    href="main/livecode/389/928/5389?pr=0"><i
                                                                        class="la la-code"></i> | Belajar melalui
                                                                    Error<span class="float-right"><i
                                                                            class="la la-check"></i></span>
                                                                </a>
                                                                <a class="chapter_item_item "
                                                                    href="main/livecode/389/928/5410?pr=0"><i
                                                                        class="la la-code"></i> | Menghasilkan Grafik pada
                                                                    Live
                                                            ...
                                                            <div class="chapter_item_footer">
                                                                <div class="progress" style="margin-top:20px;">
                                                                    <div class="progress-bar progress-bars"
                                                                        role="progressbar" aria-valuenow="100.00"
                                                                ...
                                                                <a class="btn btn-raised  " data-chapter-id="928"
                                                                    ...
                                                                    href="/sub-materi/index?id={{ $materi->id }}">Mulai
                                                                    Belajar</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="chapter_item_contents">
                                                            ...
                                                            <p>
                                                                <span style="color: rgb(33, 37, 41);">
                                                                    ...
                                                                    Byte-craft. Dalam bab ini, Anda akan belajar tentang apa
                                                                    itu
                                                                    Byte-craft, manfaat dari memilih Byte-craft sebagai
                                                                    platform
                                                                    belajar,
                                                            ...
                                                            <div class="chapter_item_footer">
                                                                ...
                                                                <a class="btn btn-raised  " data-chapter-id="928"
                                                                    data-last-chapter-item-id="5390"
                                                                    style="background-color: #179AB1; color:white;padding: 6px 16px 6px 16px;border-radius: 8px; float: right; margin-top:10px;"
                                                                    href="main/livecode/389/928/5390?pr=0">Mulai
                                                                    Belajar</a>
                                                            </div>
                                                        </div>
                                                    </div>
