...
@section('container')
    <div class="col-md-12 col-sm-12" style="margin-bottom:30px; padding-left:40px; padding-top:15px; padding-right:20px; ">
        ...
        <form method="post" action="{{ route('sub-materi.store', $materi->id) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="type">Type Isi</label>
                <select class="form-control" name="type" id="type">
                    <!-- Add options for different social media icons -->
                    <option value="1">Hanya Text</option>
                    <option value="2">Text dan code</option>
            ...
            <div class="flex justify-end col-mt-8">
                ...
                <a href="{{ route('sub-materi.crud',["id=$materi->id"]) }}"
