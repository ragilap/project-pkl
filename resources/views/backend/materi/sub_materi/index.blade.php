...
<div style="overflow:auto;">
    <div id="book_content">
        <h2 class="sub_chapter_title">Kenapa Belajar Data harus Coding?</h2>
        @foreach ($submateries as $materi)
            {!! $materi->deskripsi !!}
        @endforeach
        <div class="alert-liveclass-2" style="display: none; margin: 0px 0px 14px;">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                role="img" class="iconify iconify--fxemoji" width="1em" height="1em"
                preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" data-icon="fxemoji:lightbulb"
            ...
            <p>Klik tombol <strong>Next</strong> untuk melanjutkan ke materi selanjutnya.</p>
            <div class="btn-skip">
                <button class="btn btn-primary bg_color_2" id="btn_skips"
                    style="border-radius: 3px; border: none; box-shadow: none;">Next
                </button>
            </div>
        </div>
    </div>
