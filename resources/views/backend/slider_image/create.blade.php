            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="flex justify-end col-mt-8">
                    ...
                    <a href="{{ route('sliderimage.crud') }}" class="bg-red-500 text-white ml-4 px-4 py-2 rounded">Kembali</a>
                </div>
        </form>
    </div>
@endsection
