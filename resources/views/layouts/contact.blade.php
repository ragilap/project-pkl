                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item ">
                        <a href="{{route('album.crud')}}" class="nav-link">
                           ...
                           style="fill: white;"  src="{{ asset('img/album-photo-white.svg') }}">
                            <p style="margin-left: 40px;">Photo</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('album.video.crud')}}" class="nav-link">
                            <img class="position-absolute ml-2 w-5 h-5" src="{{ asset('img/album-video white.svg') }}"
                                >
                            <p style="margin-left:40px;">Video</p>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item pl-1 ">
                        <a href="{{route('contact.crud')}}" class="nav-link active">
                            <img class="w-5 h-5 ml-2 position-absolute " src="{{ asset('img/contact-us-black.svg') }}"
                                alt="about us">
