        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item pl-1 ">
                    <a href="{{route('infovalue.crud')}}" class="nav-link active" >
                        {{-- <img class="w-5 h-5 ml-2 position-absolute " src="{{ asset('img/information-black.svg') }}"
                                alt="about us"> --}}
                        <span class="mbri-growing-chart ml-2 position-absolute font-bold mt-1" style="margin-left:14px; font-weight:bold;"></span>
                        <p style="padding-left: 43px; color:black;">Our value</p>
                    </a>
                </li>
            </ul>
            </li>
