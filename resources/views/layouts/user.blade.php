...
<head>
    ...
    <title>BPPI | Dashboard</title>

    <script src="{{asset('sweetalert2.min.js')}}"></script>
    <link rel="stylesheet" href="{{ asset('sweetalert2.min.css')}}">

    <link rel="stylesheet" href="{{ asset ('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-GLoNUvq4Wb6iozWzpCzsevUyazHnd9Fz2CeiRRy3WCMnILkZk6/7y/jo4KlW7fN9" crossorigin="anonymous')}}">
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js'])
            ...
            <body class="hold-transition sidebar-mini layout-fixed font-sans antialiased ">
                <div class="wrapper">
                    ...
                    <div class="preloader flex-column justify-content-center align-items-center">
                        <img class="animation__shake" src="{{asset('template/img/favicon.png')}}" alt="Bppi" height="60"
                            width="60">
                    </div>
        ...
        <aside class="main-sidebar position-fixed sidebar-dark-primary elevation-4 sidebar-mini">
            ...
            <a href="https://www.bppi.sch.id/" class="brand-link">
                <img src="https://i.pinimg.com/1200x/7c/ec/6b/7cec6b16f7ecc1ef777bc47ba1a78aa2.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
            ...
            <div class="sidebar" style="height: 100%">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item ">
                            <a href="{{route('article.crud')}}" class="nav-link d-flex align-items-center">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item pl-1 ">
                                    <a href="{{route('contact.crud')}}" class="nav-link  ml-3">
                                ...
                                <li class="nav-item pl-1 ">
                                    <a href="{{route('info.crud')}}" class="nav-link ml-3">
                        ...
                        <li class="nav-item pl-1 ">
                            <a href="{{route('infovalue.crud')}}" class="nav-link ml-3">
                                {{-- <img class="w-5 h-5 ml-2 position-absolute " src="{{ asset('img/information-black.svg') }}"
                                        alt="about us"> --}}
                                <span class="mbri-growing-chart mt-1 position-absolute" style=" margin-left:10px; font-weight:bold;"></span>
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ route('user.index') }}" class="nav-link active d-flex align-items-center">
                        ...
                        {{-- <li class="nav-item ">
                            <a href="{{ route('pelanggan.index') }}" class="nav-link">
                                <i class="fas fa-users" style=" margin-left:3px; margin-right:10px;"></i>
                                <p>
                                    Customer
                                </p>
                            </a>
