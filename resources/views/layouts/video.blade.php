               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item  ">
                    <a href="{{ route('article.crud') }}" class="nav-link d-flex align-items-center">
                        <i class="nav-icon fas fa-book position-fixed" style="color:#fafafa;"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item pl-1 ">
                            <a href="{{ route('album.crud') }}" class="nav-link">
                                <img class="ml-2 w-5 h-5 position-absolute" style="fill: white;"
                                    src="{{ asset('img/album-photo-white.svg') }}">
                                <p style="padding-left: 40px;">Photo</p>
                            </a>
                        </li>
                        <li class="nav-item pl-1 ">
                            <a href="{{ route('album.video.crud') }}" class="nav-link active">
                                <img class="position-absolute ml-2 w-5 h-5" src="{{ asset('img/album-video.svg') }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item pl-1 ">
                            <a href="{{ route('info.crud') }}" class="nav-link ">
                                <img class="w-5 h-5 ml-2 position-absolute "
                                    src="{{ asset('img/information-white.svg') }}" alt="about us">
                ...
                <li class="nav-item pl-1 ">
                    <a href="{{ route('infovalue.crud') }}" class="nav-link ">
                        {{-- <img class="w-5 h-5 ml-2 position-absolute " src="{{ asset('img/information-black.svg') }}"
                            alt="about us"> --}}
                        <span class="mbri-growing-chart mt-1 position-absolute"
                ...
                <li class="nav-item">
                    <a href="{{ route('user.index') }}" class="nav-link d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                            style="fill:#fafafa; position:fixed; margin-left:5px" viewBox="0 0 640 512">
                            <path
