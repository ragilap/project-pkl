                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{ route('user.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <x-text-input class="form-control" type="text" name="username" value="{{ old('username', $row->username) }}" style="width: 600%; margin-left:30px;" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <x-text-input class="form-control" type="password" name="password" style="width: 600%; margin-left:30px;" />
                                </div>
                            </div>
