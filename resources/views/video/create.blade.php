    ...
    <div class="col-md-12 col-sm-12 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6"
        ...
        <form action="{{ route('video.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="judul" class="form-group">Nama video:</label>
                <input type="text" name="judul" placeholder="Nama video" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="deskripsi" class="form-group">Deskripsi</label>
                <input type="text" name="deskripsi" placeholder="Deskripsi" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="file_path" class="form-group">File Video :</label>
            ...
            <div class="form-group">
                ...
                <div class="flex justify-end col-mt-8">
                    ...
                    <a href="{{ route('video.crud', ['id' => $galeriId]) }}"
