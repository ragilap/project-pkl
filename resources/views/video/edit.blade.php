    ...
    <div class="col-md-12 col-sm-12 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6"
        ...
        <header>
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                <a>Update Your {{ $galery->albumvideo->nama_album }} Video</a>
            </h2>

            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400" style="margin-bottom: 15px">
                {{ __('Update your Video for Galery Video informations.') }}
            </p>
        </header>
        <form method="post" action="{{ route('video.update', $galery->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                @elseif ($galery->type_id === 2)
                    <video style="max-width: 300px; max-height: 250px; border-radius:4px;" controls>
            ...
            <div class="flex justify-end col-mt-8">
                ...
                <a href="{{ route('video.crud', ['id' => $galery->parent_id]) }}"
